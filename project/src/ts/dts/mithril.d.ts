 ...
 * @see m.component
 */
declare function m<T extends m.Controller>(
  selector: string,
...
declare module m {
   ...
   * @see m.withAttr
   */
  function prop<T>(promise: Thennable<T>) : PromiseProperty<T>;
   ...
   * @see m.withAttr
   */
  function prop<T>(value: T): BasicProperty<T>;
   ...
   * @see m.withAttr
   */
  function prop<T>(): BasicProperty<T>;
   ...
   */
  function mount<T extends Controller>(
    rootElement: Node,
   ...
   * @see m
   */
  function component<T extends Controller>(
    component: Component<T>,
        ...args: any[]
  ): Component<T>;
   ...
   * it as trusted.
   */
  function trust(html: string): TrustedString;
  ...
  module redraw {
     ...
     */
    function strategy(value: string): string;
   ...
   */
  function route<T extends Controller>(
    rootElement: Element,
    defaultRoute: string,
    routes: Routes<T>
  ): void;
  ...
  module route {
     ...
     */
    function buildQueryString(data: Object): string
     ...
     */
    function parseQueryString(data: string): Object
  }
   ...
   */
  function request<T>(options: XHROptions<T>): Promise<T>;
   ...
   */
  function sync<T>(promises: Thennable<T>[]): Promise<T[]>;
   ...
   */
  interface Promise<T> extends Thennable<T>, Property<Promise<T>> {
    /**
